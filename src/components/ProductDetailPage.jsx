                ...
                <div>
                    ...
                    <div className="space-y-8 border-t border-gray-100 pt-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            ...
                            <button
                                onClick={() => onAddToCart && onAddToCart({ ...product, size: selectedSize, color: selectedColor, quantity })}
                                className="flex-1 bg-accent hover:bg-opacity-90 text-white py-4 px-8 rounded-md font-bold tracking-wide transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-3 text-lg"
                            >
